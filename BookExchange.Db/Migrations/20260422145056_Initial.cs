    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BooksOfTheDay", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BooksOfTheDay_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    BookOfferedId = table.Column<int>(type: "integer", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_Books_BookOfferedId",
                        column: x => x.BookOfferedId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_ExchangeRequests_Books_BookRequestedId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CorrectAnswer = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    Option2 = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    Option3 = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    Option4 = table.Column<string>(type: "character varying(300)", maxLength: 300, nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_QuizQuestions_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "integer", nullable: false)
                        .Annotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.IdentityByDefaultColumn),
                    ExchangeRequestId = table.Column<int>(type: "integer", nullable: false),
                    SenderId = table.Column<string>(type: "text", nullable: false),
                    Text = table.Column<string>(type: "character varying(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Messages_ExchangeRequests_ExchangeRequestId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Reviews_ExchangeRequests_ExchangeRequestId",
                        column: x => x.ExchangeRequestId,
                        principalTable: "ExchangeRequests",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BooksOfTheDay_BookId",
                table: "BooksOfTheDay",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BooksOfTheDay_Date",
                table: "BooksOfTheDay",
                column: "Date",
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_BookOfferedId",
                table: "ExchangeRequests",
                column: "BookOfferedId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequests_BookRequestedId",
                table: "ExchangeRequests",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Messages_ExchangeRequestId",
                table: "Messages",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_QuizQuestions_BookId",
                table: "QuizQuestions",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_Reviews_ExchangeRequestId",
                table: "Reviews",
                column: "ExchangeRequestId");
