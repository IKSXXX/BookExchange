...
public static class DbSeeder
{
    ...
    Year = 1866,
    Description = "Великий роман о преступлении и наказании, о раскаянии и вере.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780140449136-M.jpg",
    OwnerId = userMap["anna"].Id,
    IsAvailable = true
},
...
new() {
    ...
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780451524935-M.jpg",
    OwnerId = userMap["igor"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Year = 1967,
    Description = "Мистический роман о любви, дьяволе и Москве 30-х.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780679760801-M.jpg",
    OwnerId = userMap["elena"].Id,
    IsAvailable = false
},
...
new() {
    ...
    CoverImagePath = "https://images.unsplash.com/photo-1495446815901-a7297e633e8d?w=400&h=600&fit=crop",
    OwnerId = userMap["anna"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Good,
    Year = 1997,
    Description = "Первая книга о мальчике-волшебнике, открывшем мир магии.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780590353427-M.jpg",
    OwnerId = userMap["dmitry"].Id,
    IsAvailable = true
},
...
new() {
    ...
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780060883287-M.jpg",
    OwnerId = userMap["olga"].Id,
    IsAvailable = true
},
...
new() {
    ...
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780553103540-M.jpg",
    OwnerId = userMap["pavel"].Id,
    IsAvailable = true
},
...
new() {
    ...
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780140448108-M.jpg",
    OwnerId = userMap["maria"].Id,
    IsAvailable = true
},
...
new() {
    ...
    CoverImagePath = "https://images.unsplash.com/photo-1457369804613-52c61a468e7d?w=400&h=600&fit=crop",
    OwnerId = userMap["sergey"].Id,
    IsAvailable = true
},

new() {
    Title = "Преступные намерения",
    Author = "А. Кристи",
    Genre = "Детектив",
    Condition = BookCondition.Good,
    Year = 1939,
    Description = "Классический детектив Агаты Кристи.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780062073488-M.jpg",
    OwnerId = userMap["igor"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Good,
    Year = 1862,
    Description = "Роман о конфликте поколений и идеологий.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780140448931-M.jpg",
    OwnerId = userMap["elena"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Excellent,
    Year = 1892,
    Description = "Сборник рассказов о гениальном сыщике.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780140437713-M.jpg",
    OwnerId = userMap["dmitry"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Good,
    Year = 1878,
    Description = "Трагическая история любви в высшем свете Российской империи.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780140449174-M.jpg",
    OwnerId = userMap["anna"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Acceptable,
    Year = 1925,
    Description = "Философский роман о безумии бюрократической системы.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780805209990-M.jpg",
    OwnerId = userMap["olga"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Good,
    Year = 1962,
    Description = "Провокационный роман о подростке-психопате и социальной инженерии.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780393312836-M.jpg",
    OwnerId = userMap["pavel"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Excellent,
    Year = 1925,
    Description = "История любви и разочарования в эпоху джаза.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780743273565-M.jpg",
    OwnerId = userMap["maria"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Good,
    Year = 1932,
    Description = "Антиутопия о мире тотального комфорта и потери человечности.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780060850524-M.jpg",
    OwnerId = userMap["sergey"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Good,
    Year = 1960,
    Description = "Глубокий роман о расовых предрассудках и справедливости глазами ребёнка.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780060935467-M.jpg",
    OwnerId = userMap["olga"].Id,
    IsAvailable = true
},
...
new() {
    ...
    Condition = BookCondition.Excellent,
    Year = 1951,
    Description = "Исповедь подростка о лицемерии взрослого мира.",
    CoverImagePath = "https://covers.openlibrary.org/b/isbn/9780316769488-M.jpg",
    OwnerId = userMap["anna"].Id,
    IsAvailable = true
}
            };
